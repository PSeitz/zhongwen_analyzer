...
fn app() -> Html {
    ...
    let on_input = {
        ...
        Callback::from(move |e: InputEvent| {
            ...
            let mut input_text = input_element.value();
...
fn right_pane(AnalyzedTextProps { tokens }: &AnalyzedTextProps) -> Html {
    ...
    html! {
        <div style="flex: 1; padding: 10px;">
            <select onchange={on_mode_change} value={match *mode { DisplayMode::PinyinWithTranslation => "PinyinWithTranslation", DisplayMode::UniqueWordsWithCounts => "UniqueWordsWithCounts" }}>
